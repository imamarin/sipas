...
<html>
    ...
    <body>
        <div class="header">
            ...
            <p style="font-size: 10px">Komplek Pesantren Cintawana Desa Cikunten Kecamatan Singaparna Kabupaten
                Tasikmalaya Jawa Barat Kode Pos 46414</p>
            <p style="font-size: 10px">Telp. 0265 546717 email: smkypctasikmalaya@gmail.com</p>
        </div>

        <center>
            <h5 style="font-size: 15px; margin: 0;">LAPORAN SURAT KELUAR</h5>
