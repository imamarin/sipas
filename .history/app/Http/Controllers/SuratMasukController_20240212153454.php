...
class SuratMasukController extends Controller
{
    public function show()
    {
        if (Auth::user()->role === "superadmin" || Auth::user()->role === "admin") {
            ...
            $data['suratmasuk1'] = SuratMasuk:: SuratMasuk::select('surat_masuks.*', 'perihal.*', 'perihal.perihal as nmperihal', 'surat_masuks.id as IdSuratMasuk')
                ->join('perihal', 'surat_masuks.id_perihal', '=', 'perihal.id')->with('unitkerja')
                ->with('perihal')
            ...
            $data['unitkerja'] = UnitKerja::all();
            $data['suratmasuk'] = SuratMasuk::select('surat_masuks.*', 'perihal.*', 'perihal.perihal as nmperihal', 'surat_masuks.id as IdSuratMasuk')
